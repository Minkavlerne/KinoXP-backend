package org.example.kinoxpbackend.security.config;

import com.nimbusds.jose.jwk.source.ImmutableSecret;
import org.example.kinoxpbackend.security.error.CustomOAuth2AccessDeniedHandler;
import org.example.kinoxpbackend.security.error.CustomOAuth2AuthenticationEntryPoint;
...
public class SecurityConfig {
  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http, HandlerMappingIntrospector introspector) throws Exception {
    ...
    http.authorizeHttpRequests((authorize) -> authorize
            ...
            // /theaters Endpoints
            .requestMatchers(mvcMatcherBuilder.pattern(HttpMethod.GET, "/theaters")).permitAll()
            .requestMatchers(mvcMatcherBuilder.pattern(HttpMethod.GET, "/theaters/*")).permitAll()
            .requestMatchers(mvcMatcherBuilder.pattern(HttpMethod.POST, "/theaters")).permitAll()
            ...
            .requestMatchers(mvcMatcherBuilder.pattern(HttpMethod.PUT, "/movies/*")).permitAll()
            ...
            .requestMatchers(mvcMatcherBuilder.pattern(HttpMethod.POST, "/categories")).permitAll()
